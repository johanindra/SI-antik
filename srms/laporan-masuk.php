...
<div class="panel-body p-20">
    <div class="table-responsive">
        ...
        <tbody>
            <?php
            $sql = "SELECT NIK, nama_lengkap, alamat, tanggal_laporan FROM laporan_masuk";
                ...
                foreach($results as $result) { ?>
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <!-- <a href="detail-laporan.php?NIK=<?php echo htmlentities($result->NIK); ?>"><i class="fa fa-edit" title="Detail"></i></a>  -->
